...
class Adimoviebox : MainAPI() {
    ...
    // Identitas perangkat unik & User-Agent stabil
    ...
    // ✅ FIX: Menggunakan /home agar isi "Sedang Tren" sama dengan situsnya
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        // ✅ Jeda berjenjang (Anti-Flood) untuk mengatasi IOException Canceled
        ...
        // Timeout 45 detik biar nggak kena Coroutine Cancelled
        val response = app.get(url, headers = getHeaders(), timeout = 45).parsedSafe<Media>()?.data
        
        // Filter film yang posternya null agar UI nggak rusak
    ...
    override suspend fun loadLinks(
        ...
        // Wajib kirim detail_path dan timeout lama agar link ketemu
        val res = app.get(
...
data class Items(
    ...
    fun toSearchResponse(provider: Adimoviebox): SearchResponse {
        return provider.newMovieSearchResponse(
            ...
            this.posterUrl = cover?.url ?: coverVerticalUrl // Fix Null Poster
        }
    }
