...
// ================= CONSTANTS BARU UNTUK SUBTITLE =================
const val OpenSubtitlesApiUrl = "https://opensubtitles-v3.strem.io" // Nama beda biar gak konflik sama Class
...
suspend fun invokeSubtitleAPI(
    ...
    try {
        ...
        res?.subtitles?.forEach { sub ->
            val langName = getLanguageNameFromCode(sub.lang) ?: sub.lang
