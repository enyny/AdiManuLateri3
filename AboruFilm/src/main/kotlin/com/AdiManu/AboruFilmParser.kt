...
data class MovieData(
    val id: Int?, val title: String?, val poster: String?, val description: String?, 
    val year: Int?, val imdb_id: String?, val imdb_rating: String?, val trailer_url: String?
)

data class SeriesDataProp(val data: SeriesData? = null)
data class SeriesData(
    val id: Int?, val title: String?, val poster: String?, val description: String?, 
    val imdb_id: String?, val season: List<Int> = emptyList()
)

data class SeriesSeasonProp(val data: List<SeriesEpisode>? = null)
data class SeriesEpisode(
    val id: Int?, val tid: Int?, val season: Int?, val episode: Int?, 
    val title: String?, val synopsis: String?, val thumbs_original: String?
)
